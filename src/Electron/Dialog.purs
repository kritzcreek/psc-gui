...
foreign import showOpenDialogImpl ::
  forall eff.
  DialogOptions ->
  Eff (dialog :: DIALOG | eff) (Array String)

showOpenDialog :: forall eff. DialogOptions -> Eff (dialog :: DIALOG | eff) (Array String)
showOpenDialog opts = showOpenDialogImpl opts
